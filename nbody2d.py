...
class Particle:
    ...
    def __init__(self, index) -> None:
        ...
        # Масса
        self.mass = np.random.uniform(0.1, 0.7)
...
def init():
    ...
    fig.tight_layout()
    ax.set(xlim=(0, 1), ylim=(0, 1), xticks=np.arange(0, 1), yticks=np.arange(0, 1))
    ...
    for time in range(STEPS_LIMIT):
        ...
        plt.pause(0.05)
        #plt.savefig('nbody/' + str(time) + 'body.png')
